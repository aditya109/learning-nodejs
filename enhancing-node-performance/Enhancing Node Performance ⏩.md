...
- [Enhancing Node Performance](#enhancing-node-performance)
  * [Table of Contents](#table-of-contents)
  * [How to improve Node Performance?](#how-to-improve-node-performance-)
    + [Normal NodeJS Server Flow](#normal-nodejs-server-flow)
    + [How clustering solves this issue ?](#how-clustering-solves-this-issue--)
      - [Blocking Process](#blocking-process)
      - [Solving the Problem by using `fork()`](#solving-the-problem-by-using--fork---)
        * [Another example of `fork()`:](#another-example-of--fork----)
      - [Implementing Clustering in a normal `express` app](#implementing-clustering-in-a-normal--express--app)
  ...
  * [Async, Await and Promises](#async--await-and-promises)
    + [Using `Promises.all`](#using--promisesall-)
